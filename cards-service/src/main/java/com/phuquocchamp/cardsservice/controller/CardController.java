package com.phuquocchamp.cardsservice.controller;
...
import com.phuquocchamp.cardsservice.dto.ErrorResponseDto;
import com.phuquocchamp.cardsservice.dto.ResponseDto;
...
public class CardController {
    ...
    @Operation(
            ...
            description = "Get Java Info that is deployed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
